...
class CaptchaGenerator:
    ...
    def gen_captcha_image(self, difficult_level=2, captcha_string='1234', multicolor=False, \
            margin=True):
        ...
        # Generate N one-character images with a random char color in contrast to the generated 
        # background, a random font and font size, and random position-rotation
        one_char_images = []
        image_characters = ""
        for i in range(0, len(captcha_string)):
